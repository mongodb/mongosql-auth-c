                             ...
                             uint32_t iterations)
{
   ...
   /* output contains the accumulated XOR:ed result */
...
#define SASL_PREP_ERR_RETURN(msg)                        \
   ...
   /* convert. */
   error_code = U_ZERO_ERROR;
   out_utf16 = malloc (sizeof (UChar) * (out_utf16_len + 1));
