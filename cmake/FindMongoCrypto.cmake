...
IF(APPLE)
    ...
    set(MONGO_CRYPTO_LIBS "$ENV{WITH_SSL}/lib/libcrypto.1.0.0.dylib" "$ENV{OPENSSL_PATH}/lib/libssl.1.0.0.dylib")
    include_directories("$ENV{WITH_SSL}/include")
    MESSAGE(STATUS "OpenSSL include path: $ENV{WITH_SSL}")
